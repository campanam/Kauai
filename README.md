# Kauai Honeycreepers Analysis Pipeline  

Michael G. Campana, 2021-2022  

This is an alignment and genotyping pipeline for Kauai endangered honeycreeper population genomics. It is provided only for reference as it has been superceded. See the [campanam/Elephant](https://github.com/campanam/Elephants) pipeline for modern sample processing and the [campanam/MuseumSpecimens](https://github.com/campanam/MuseumSpecimens) pipeline for museum and ancient DNA processing. See [ckyriazis/honeycreeper_genomics](https://github.com/ckyriazis/honeycreeper_genomics) for the scripts used in the final manuscript.  
